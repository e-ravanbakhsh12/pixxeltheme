(function ($) {
  ...
  class Landing {
    constructor() {
      ...
      $(".splide-project").each(function (e) {
        const gallery = new Splide($(this).get(0), {
          type: "loop",
          direction: "rtl",
          // drag:'free',
          autoplay: true,
          ...
          classes: {
            arrow: "splide__arrow ",
            prev: "splide__arrow--prev gallery-class-prev group-1",
            next: "splide__arrow--next your-class-next group-1",
          },
        });
        gallery.mount();
        $(this)
